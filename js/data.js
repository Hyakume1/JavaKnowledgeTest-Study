const DATA = [
  ...
  },
  {
    ...
    questions: [
      { q: "What is output to the screen?", choices: ["%d - %s","age - name","20 - Alice"], answer: 2, code: "String name = \"Alice\";\ndouble gpa = 3.5;\nint age = 20;\nSystem.out.printf(\"%d - %s\", age, name);" },
  ...
  },
  {
    ...
    questions: [
      { q: "Which input causes an exception for this code?", choices: ["12 34 two","43 -7","17 two 3"], answer: 2, code: "int num1 = 0, num2 = 0;\nnum1 = scnr.nextInt();\nnum2 = scnr.nextInt();" },
      { q: "Which input also causes an exception when reading two integers?", choices: ["5 13","35 45.1","12    34"], answer: 1, code: "int num1 = 0, num2 = 0;\nnum1 = scnr.nextInt();\nnum2 = scnr.nextInt();" },
      { q: "Which input causes an exception when reading a double?", choices: ["+5 0","1,0 23","1,000 23000"], answer: 1, code: "distMiles = scnr.nextDouble();" },
    ]
  },
  {
    ...
    questions: [
      ...
      { q: "Which catch block catches the exception thrown by this throw statement?", choices: ["catch ( Exception excpt ) { // ... }","catch ( InputMismatchException excpt ) { // ... }","catch ( ArithmeticException excpt ) { // ... }"], answer: 0, code: "throw new Exception(\"0.0 / 0.0 is not a number\");" },
      { q: "In the CircleRadiusCalculator program, what is output when the input is the word \"pi\"?", choices: ["Invalid input.","Invalid area.","Invalid area. Invalid input.","1.0"], answer: 0, code: "import java.util.Scanner;\nimport java.util.InputMismatchException;\n\npublic class CircleRadiusCalculator {\n    public static void main(String[] args) {\n        Scanner scnr = new Scanner(System.in);\n        try {\n            System.out.print(\"Enter radius: \");\n            double radius = scnr.nextDouble();\n            if (radius <= 0.0)\n                throw new Exception(\"Invalid area.\");\n            double area = Math.PI * radius * radius;\n            System.out.printf(\"Area: %.2f%n\", area);\n        } catch (InputMismatchException e) {\n            System.out.println(\"Invalid input.\");\n        } catch (Exception e) {\n            System.out.println(e.getMessage());\n        }\n    }\n}" },
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "The input file is found, but the output file cannot be opened. Which file(s) are left open?", choices: ["Only input.txt","Only output.txt","Both files are left open","No file is left open"], answer: 0, code: "// Code WITHOUT try-with-resources:\n// fileInStream = new FileInputStream(\"input.txt\");\n// fileWriter = new PrintWriter(new FileOutputStream(\"output.txt\"));\n// catch(FileNotFoundException) only — no finally" },
      { q: "Both input and output files are opened, but an InputMismatchException is thrown while reading. Which file(s) are left open?", choices: ["Only input.txt","Only output.txt","Both files are left open","No file is left open"], answer: 2, code: "// Code WITHOUT try-with-resources:\n// fileInStream = new FileInputStream(\"input.txt\");\n// fileWriter = new PrintWriter(new FileOutputStream(\"output.txt\"));\n// catch(FileNotFoundException) only — no finally" },
  ...
  },
  {
    ...
    questions: [
      { q: "Which input sequence causes an unintended exception type to be caught?", choices: ["-1.0 10.0","0.0 0.0","20 twenty"], answer: 2, code: "// DensityCalculator — main() uses a too-broad catch block:\ntry {\n    System.out.printf(\"Density: %.4f%n\", getDensity(scnr));\n} catch (Exception e) {\n    // catches EVERYTHING — including InputMismatchException\n    System.out.println(\"Error: \" + e.getMessage());\n}\n\n// getDensity() can throw:\n//   InvalidNegativeInputException — if mass or volume < 0\n//   NaNException                  — if density is NaN (0.0/0.0)" },
      { q: "Which scenario causes an unintended exception type to be caught in getDensity()?", choices: ["The scnr parameter in getDensity() is null.","The input sequence 0.0 10.0","The input sequence 10.0 0.0"], answer: 0, code: "// DensityCalculator — main() uses a too-broad catch block:\ntry {\n    System.out.printf(\"Density: %.4f%n\", getDensity(scnr));\n} catch (Exception e) {\n    // catches EVERYTHING — including NullPointerException\n    System.out.println(\"Error: \" + e.getMessage());\n}\n\n// getDensity() can throw:\n//   InvalidNegativeInputException — if mass or volume < 0\n//   NaNException                  — if density is NaN (0.0/0.0)" },
